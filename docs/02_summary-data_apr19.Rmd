...
```{r filter, echo=FALSE, message=FALSE, optipng='-o7', fig.cap= "Setup of the vacuum manifold with the cellulose nitrate filter units.", fig.width=4, fig.height=2}
