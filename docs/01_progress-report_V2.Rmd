...
```{r EMA, echo=FALSE, message=FALSE, optipng='-o7', fig.cap= "Figure 4. Viability staining protocol for quantification of live vs. dead Bd zoospores.", fig.width=4, fig.height=2}
...
Table S2. Summary of mortality records for tadpoles, split by species and exposure regime. 
...
```{r summary proportion infected, echo=F}
