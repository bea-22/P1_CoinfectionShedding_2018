...
Exposure scenario predicted infection status and load for ranavirus: tadpoles exposed to the series of Bd doses and then to Rv were **significantly** more likely to develop ranaviral infections (GLM; χ2 = XXX; p < .001 ####, Figure XXXXX), which were more likely to be at a high viral titre (GLM; χ2 = XXX; p < .001 ****, Figure XXXXX //// Rv only = XXXX ± XXXX, Bd - Rv = XXX ± XXX, Rv - Bd = XXXX ± XXX, GLM, F = XXXX, p < .001; XXXX). 
