...
boxplot.Bd <- plot.Bd.GE.sp + theme(legend.key=element_blank(), legend.text= element_text(size=12, face = "italic"), legend.title=element_text(size=16)) + 
...
boxplot.Rv <- plot.Rv.load.sp +  theme(legend.key=element_blank(), legend.text= element_text(size=12, face = "italic"), legend.title=element_text(size=16)) + 
   theme(axis.text.x = element_text(angle=30, hjust=1, vjust=1, size = 10), axis.text.y = element_text(size = 10), axis.title = element_text(size=16)) 
...
```{r playing with plots for publication } 
