...
```{r endpoint, echo=FALSE, message=FALSE, optipng='-o7', fig.cap= "*Left* DNA extraction procedure for endpoint tissue samples. *Right* ", fig.show='hold', out.width = "50%", fig.align = "default"}

include_graphics(c("../output/images/endpoint-sample.png", "../output/images/qPCR.png"))
``` 
...
```{r filter, echo=FALSE, message=FALSE, optipng='-o7', fig.cap= "Setup of the vacuum manifold with the cellulose nitrate filter units.", out.width = "50%"}

include_graphics("../output/images/filters.png")
``` 
...
```{r proportion, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, fig.cap= "Proportion of individuals infected, by pathogen, within a treatment group for the three host species. N.B. that *Alytes* II is excluded.", fig.width=16, fig.height=10}
...
```{r Bd-GE-plot, echo=FALSE, error=FALSE, message=FALSE, fig.cap= "Boxplot of the endpoint Bd load for each treatment group across the three host species. Bd load is quantified as genomic equivalents (GE) where 1 GE represents 1 Bd zoospore. The black dots represent each sample.", fig.width=16, fig.height=10}
...
```{r Rv-plot, echo=FALSE, error=FALSE, message=FALSE, fig.cap= "Boxplot of the endpoint Ranaviral load for each treatment group across the three host species. Viral load has been normalised using Leung et al.'s (2017) method. The black dots represent each sample.", fig.width=16, fig.height=10}
...
include_graphics(c("../output/images/ACCE-logo.png", "../output/images/zsl.png"))
``` 
