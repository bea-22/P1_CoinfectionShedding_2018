...
<br>
The AIC (assessing parameters contributions to the model) suggests you don't gain much explanatory power by adding a parameter (Treatment) to the ExperimentNo. only model. 
