...
Bd.load2.1 <- glm(Bd.endpoint.GE ~ Treatment + ExperimentNo, data=Bd.load, family=gaussian())
summary(Bd.load2.1)   #AIC = 2226.8  #Residual deviance:  862653  on 190  degrees of freedom
plot(Bd.load2.1)

Bd.load2.2 <- glm(Bd.endpoint.GE ~ Treatment + ExperimentNo, data=Bd.load, family=Gamma())
summary(Bd.load2.2)   #AIC = 1832.7  #Residual deviance: 239.21  on 190  degrees of freedom
plot(Bd.load2.2)
